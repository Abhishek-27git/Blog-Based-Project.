...
- [x] Copy `.env.example` → `.env` and fill in your real `MONGO_URI`

### Phase 2 — Authentication (Days 3–4)
- [x] Implement register/login controllers
- [x] Implement JWT token generation (access + refresh)
- [x] Create `auth` middleware for protecting routes
- [x] Create `roleGuard` middleware
- [x] Implement Google OAuth with Passport.js
- [x] Implement token refresh & logout
- [x] Create admin seed script
- [x] Test all auth endpoints with Postman/Thunder Client

### Phase 3 — Blog CRUD (Days 5–6)
- [x] Implement blog CRUD controllers
- [x] Add slug generation with `slugify`
- [x] Set up Cloudinary for image uploads
- [x] Create `ownership` middleware
- [x] Add like/unlike functionality
- [x] Add pagination, filtering, search
- [x] Test all blog endpoints

### Phase 4 — Comments (Day 7)
- [x] Implement comment CRUD controllers
- [x] Add nested replies support
- [x] Test comment endpoints

### Phase 5 — Admin Backend (Day 8)
- [x] Implement admin dashboard analytics
- [x] Implement user management (list, ban, delete)
- [x] Implement blog/comment moderation
...
- [x] Create layouts (Main, Dashboard, Admin)
- [x] Set up Axios instance with interceptors
- [x] Create AuthContext

### Phase 7 — Frontend Auth Pages (Days 11–12)
- [x] Build Login, Register pages
- [x] Integrate Google OAuth button
- [x] Implement protected/admin routes
- [x] Build Navbar with auth state

### Phase 8 — Frontend Blog Pages (Days 13–15)
- [x] Build Home page (blog listing)
- [x] Build Blog detail page
- [x] Build Blog editor (create/edit) with rich text
- [x] Build "My Blogs" page
- [x] Implement like/comment UI

### Phase 9 — Frontend Dashboards (Days 16–18)
- [x] Build User Dashboard
- [x] Build Admin Dashboard with charts
- [x] Build admin management pages (users, blogs, comments)
