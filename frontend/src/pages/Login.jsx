      ...
      <main className="w-full max-w-reading-column-max px-margin-mobile flex flex-col items-center py-stack-lg animate-in fade-in duration-700">
        ...
        <header className="mb-stack-lg text-center">
          ...
          <p className="font-body-md text-on-surface-variant italic">
            Enter the digital sanctuary for the written word.
          </p>
        </header>
        ...
        <div className="w-full max-w-[480px] bg-surface-container-lowest border border-outline-variant p-8 md:p-12 transition-all duration-300">
          ...
          <div className="text-center mb-stack-md">
            <h2 className="font-headline-md text-headline-md text-on-surface mb-3">Welcome back.</h2>
          </div>
          ...
          <div className="space-y-4 mb-8">
            ...
            >
              ...
              <span className="font-ui-label text-ui-label text-primary uppercase tracking-widest text-[11px]">
                SIGN IN WITH GOOGLE
              </span>
            </button>
          </div>
          ...
          <div className="relative flex items-center justify-center mb-8">
            ...
            <span className="relative px-4 bg-surface-container-lowest text-ui-small font-ui-small text-on-surface-variant uppercase tracking-wider text-[10px]">
              OR
            </span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-1">
              <label className="font-ui-label text-ui-small text-on-surface-variant uppercase tracking-tighter text-xs block" htmlFor="email">
                EMAIL ADDRESS
              </label>
              <input
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <a href="#" className="font-ui-small text-[11px] text-on-surface-variant/70 underline underline-offset-2 hover:text-primary transition-colors">
                  Forgot?
                </a>
              </div>
              <input
            ...
            <button
              disabled={loading}
              className="w-full bg-primary text-on-primary py-4 px-6 font-ui-label text-ui-label uppercase tracking-widest hover:bg-on-surface-variant transition-colors duration-300 disabled:opacity-50 mt-4 flex items-center justify-center gap-2"
              type="submit"
            >
              <span>{loading ? "Verifying..." : "CONTINUE TO ESSAYS"}</span>
          ...
          <div className="mt-8 text-center space-y-4">
            ...
            <div className="pt-8 border-t border-outline-variant">
              <p className="font-ui-small text-ui-small text-on-tertiary-container leading-relaxed">
                ...
                acknowledge our <a className="underline" href="#">Privacy Policy</a>.
              </p>
            </div>
          </div>
